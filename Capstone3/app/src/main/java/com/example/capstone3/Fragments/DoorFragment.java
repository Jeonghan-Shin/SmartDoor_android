...
public class DoorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final ImageButton imageButton = (ImageButton) rootView.findViewById(R.id.btn_door);

        imageButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                MyClientTask myClientTask = new MyClientTask(ipAddress, port, "door");
                myClientTask.execute();
                Toast.makeText(getActivity(), "출입문이 열렸습니다.", Toast.LENGTH_SHORT).show();
            }
        });
